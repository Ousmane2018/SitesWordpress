...
<div id="content" class="site-content">  	
    ...
    <div id="primary" class="content-area <?php style_outlet_layout_class(); ?>  columns">
		...
		<?php while ( have_posts() ) : the_post(); ?>
				...
				<section class="author-bio clearfix">
					<div class="author-info">
						...
						<div class="description">
							<h4><?php echo __( 'About Author:', 'style-outlet' ); ?> <?php the_author_posts_link(); ?></h4>
			...
			<?php if( get_theme_mod('related_posts') && function_exists( 'style_outlet_related_posts' ) ) : ?>
				<section class="related-posts clearfix">
					<?php style_outlet_related_posts(); ?>
				</section>
			<?php endif;  ?>
